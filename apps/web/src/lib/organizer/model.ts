...
export type Draft = {short_description:string;seo_title:string;seo_description:string;title:string;description:string;category_slug:string;date_iso:string|null;end_at:string|null;timezone:string;venue:string;address:string;city:string;region:string;capacity:number;age_policy:string;visibility:'PUBLIC'|'UNLISTED';access_info:string;image:string;hero_desktop:string;hero_mobile:string;faq:string;tiers:Tier[]};
...
export const emptyDraft: Draft = {short_description:'',seo_title:'',seo_description:'',title:'',description:'',category_slug:'',date_iso:null,end_at:null,timezone:'America/Santiago',venue:'',address:'',city:'',region:'',capacity:0,age_policy:'',visibility:'PUBLIC',access_info:'',image:'',hero_desktop:'',hero_mobile:'',faq:'',tiers:[]};
